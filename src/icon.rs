//! Procedurally-drawn window icon — the "Broadcast Tower Glyph" mark.
//!
//! Rendered at startup at 256×256 and handed to eframe via
//! `ViewportBuilder::with_icon`. Designed to read at small sizes: a filled
//! rounded-square background in the app's accent blue, a white tower
//! silhouette, and three concentric broadcast arcs above the antenna.
//!
//! Implemented with hand-rolled drawing primitives (filled rounded rect,
//! polygon scanline fill, thick line, arc band) so no extra crates are needed.
